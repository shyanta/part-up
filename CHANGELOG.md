...
<a name="2.9.5"></a>
## [2.9.5](https://github.com/part-up/part-up/compare/2.9.4...2.9.5) (2017-03-19)


### Bug Fixes

* **dropbox-chooser:** set to very long expire timestamp ([69d56db](https://github.com/part-up/part-up/commit/69d56db))
* **google-driver-picker:** get rid of local src and replace it with src from google server ([5ca7c43](https://github.com/part-up/part-up/commit/5ca7c43))
