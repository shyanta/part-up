...
6. In */client/stylesheets/font-faces* a new `_picons.scss` is generated, convert the content to `.sass` at (http://www.sasstoscss.com/) and replace the contents of `icons.sass` NOTE: `icons.sass` cannot be used to change icon styles, do this in */client/stylesheets/components/pu-icons.sass*
